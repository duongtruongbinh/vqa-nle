...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="src/inference/results/OEA_grpo/", help="Directory to save the results.")
    ...
    for i, item in enumerate(tqdm(data, desc=f"Running {clean_model_name}")):
        ...
        try:
            explain, answer = model.infer_grpo_OEA(item['question'], img_path)
