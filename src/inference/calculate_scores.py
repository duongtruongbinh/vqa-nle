...
def compute_bertscore_max_ref(hypotheses: list[str], references: list[list[str]], 
                              device: str = "cuda", batch_size: int = 32) -> list[float]:
    """
...
def get_nlg_scores(references: list[list[str]], hypotheses: list[str], 
                   device: str = "cuda", max_len: int = 150, batch_size: int = 32) -> dict[str, float]:
...
FILES_TO_EVALUATE = ['1_250_curr_anstype_ver2.json','2_250_curr_anstype_ver2.json','3_250_curr_anstype_ver_2.json', 'gfpo_BS2_ver3.json', 'InternVL3_5-8B.json', 'ovis_2.59b.json', 'Qwen2.5-VL-7B-Instruct.json', 'Vintern-3B-R-beta.json', 'vintern-stage1-BS2-1000step.json','vintern3b-stage1-BS1-1000steps.json','vintern3b-stage1-BS2-1000steps-gfpo.json']
